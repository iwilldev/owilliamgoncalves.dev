export function ProfilePic({
  ...
  return (
    <div
      className={`animate-from-barely-visible non-animate relative mx-auto h-[50vw] w-[50vw] animation-duration-1000 lg:h-[40vw] lg:w-[40vw] xl:h-[30vw] xl:w-[30vw] ${className}`}
    >
