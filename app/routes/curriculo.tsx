...
import { courses } from "~/data/curriculo/courses.server";
import { educations } from "~/data/curriculo/educations.server";
import { experiences } from "~/data/curriculo/experiences.server";
